...
Учитывая, что рецепты, оценки и кулинарные коллекции представляют долгосрочную ценность для пользователей, мы закладываем срок хранения основных пользовательских данных (профили, рецепты, ингредиенты, изображения) — не менее 7 лет.
...
2. .NET - рантайм. 
3. ASP.NET Core - бэкенд-фреймворк. 
4. ASP.NET Core Web API - веб-фреймворк.
5. Entity Framework Core - ORM.
6. PostgreSQL (с использованием Npgsql) - база данных.
7. Аутентификация/авторизация:
-ASP.NET Core Identity
-JWT (JSON Web Tokens)
-Microsoft Identity Framework
8. MinIO (S3-совместимое) - файловое хранилище
9. Swagger/OpenAPI - документация API

##### Frontend
1. JavaScript - язык программирования.
2. React JS - JavaScript-библиотека для разработки пользовательских интерфейсов.
3. Vite - инструмент для эффективной сборки проектов на React.
...
Реализованные Unit-тесты проверяют корректную работу backend - TheMealDB, сервиса minio, утилит.

### Интеграционные тесты

Реализованные интеграционные тесты проверяют корректность работы контроллеров (авторизация, файлы, рецепты, ингредиенты).
